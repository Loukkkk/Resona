...
public string CS_DeleteTracksTitle => IsFr ? "Supprimer ces sons ?" : "Delete these tracks?";
    ...
    public string SettingsPage_RestoreAITags => IsFr ? "Restaurer les tags originaux" : "Restore original tags";
    public string SettingsPage_RestoreAITagsDesc => IsFr ? "Annule les modifications de l'assistant et relit les tags depuis les fichiers." : "Reverts AI modifications and re-reads tags from files.";
    public string SettingsPage_RestoreAITagsBtn => IsFr ? "Restaurer" : "Restore";
    public string QueuePage_Btn_ClearAll => IsFr ? "Tout effacer" : "Clear all";
